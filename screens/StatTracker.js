...
export default class StatTracker extends Component {
  ...
  fouls_update(x){
    ...
    if(GLOBAL.fouls[x%100] >= 4)
      Alert.alert("FOUL TROUBLE", "This player is in foul trouble")
    this.props.navigation.goBack()
    ...
    for(let i =0;i<GLOBAL.prac.length;++i)
    {
      firebase
        ...
        .update({
          ...
          Make: GLOBAL.Make[GLOBAL.prac[i]],
  ...
  return (
    ...
    <TouchableOpacity style={{width:300, height:100, alignSelf:"center", top:"50%"}} onPress = {() => this.props.navigation.navigate('Subtraction',{num:this.state.temp})}>
    <ImageBackground style={{width:300, height:100,alignSelf:"center", alignItems:"center"}}source={require("../assets/BlackBrush.png")}>
        <Text style={{fontFamily:"Futura-CondensedExtraBold",color:"white", top:"28%", fontSize:40}}>Subtraction</Text>
    </ImageBackground>
  </TouchableOpacity>
